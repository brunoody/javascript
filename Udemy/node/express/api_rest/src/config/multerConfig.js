...
export default {
  ...
  storage: multer.diskStorage({ // salva no disco, no servidor, não será salva no banco de dados
    destination: (req, file, cb) => {
      cb(null, resolve(__dirname, '..', '..', 'uploads', 'images')); // cb = callback, primeiro parametro é caso dê algum erro, passamos null aqui. o segundo parametro é o caminho aone ficarão as imagens (pasta uploads)
    },
